...
const loginUser = asyncHandler(async (req, res) => {
    ...
    // options true krne se cokkie ko change nhi kr sakta h user...sirf server side se change hoga
    ...
    .json(
        ...
        // we have made a api response file in utils folder that is used here
    )
})
